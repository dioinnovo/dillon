...
export function generatePolicyAnalysisPDF(policyData: PolicyData): void {
  ...
  const accentColor = '#e74c3c' // Scott orange (minimal use)
  ...
  addText('Scott Adjusting Intelligence Platform', pageWidth/2, 18, {
    fontSize: 10,
    color: '#ffffff',
    align: 'center'
  })
  ...
  addText('This analysis was generated by Scott Claims Intelligence System', pageWidth/2, footerY, {
    fontSize: 9,
...
export function generateSimplePolicyPDF(content: string, filename: string): void {
  ...
  pdf.setFontSize(10)
  pdf.text('Scott Adjusting Intelligence Platform', pageWidth/2, 18, { align: 'center' })
